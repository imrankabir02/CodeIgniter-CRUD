...
<!-- <?php if ($post->post_image) : ?>
    <img src="<?php echo site_url('posts_images/' . $post->post_image); ?>" width="400" height="400" class="img-fluid" alt="...">
<?php else : ?>
    <img src="<?php echo site_url('posts_images/default.png'); ?>" width="400" height="400" class="img-fluid" alt="...">
<?php endif; ?> -->
<!-- <p>
